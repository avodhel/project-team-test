extends "res://Scripts/puzzles/puzzle_memorize.gd"

onready var memorize_numbers = $memorize_numbers 
onready var circles_and_numbers = $memorize_numbers/circles_and_numbers
